...
prove<Equals<Cons<string, [number, boolean]>, [string, number, boolean]>>("proof");
prove<Equals<Cons<string, [number, boolean]>, [string, number, boolean]>>("proof");
prove<Equals<Curry<[string, boolean, number], string>, (arg: string) => (arg: boolean) => (arg: number) => string>>(
    "proof");
