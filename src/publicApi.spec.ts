...
prove<Equals<typeof decoder.makeDecoder, <TIn, A>(_: (_: TIn) => validation.Validation<decoder.DecodeError, A>) => decoder.Decoder<TIn, A>>>(requireMajor("decoder.Decoder"));
...
(function validateIDecoder<TIn, A>() {
  ...
  prove<Equals<typeof idecoder.decode, (input: TIn) => validation.Validation<decoder.DecodeError, A>>>(requireMajor("decoder.Decoder.decode"));
  prove<Equals<typeof idecoder.map, <B>(f: (a: A) => B) => decoder.Decoder<TIn, B>>>(requireMajor("decoder.Decoder.map"));
  prove<Equals<typeof idecoder.replace, <B>(m: decoder.Decoder<TIn, B>) => decoder.Decoder<TIn, B>>>(requireMajor("decoder.Decoder.replace"));
  prove<Equals<typeof idecoder.replacePure, <B>(b: B) => decoder.Decoder<TIn, B>>>(requireMajor("decoder.Decoder.replacePure"));
  prove<Equals<typeof idecoder.toString, () => string>>(requireMajor("decoder.Decoder.toString"));
  prove<Equals<typeof idecoder.voidOut, () => decoder.Decoder<TIn, []>>>(requireMajor("decoder.Decoder.voidOut"));
  prove<Equals<
    typeof idecoder,
    {
      decode: typeof idecoder.decode,
...
(function validateIEither<L, A>() {
  ...
  prove<Equals<typeof ieither.matchCase, <B>(cases: either.EitherCaseScrutinizer<L, A, B>) => B>>(requireMajor("either.IEither.matchCase"));
...
prove<Equals<typeof ieitherleft.value, string>>(requireMajor("either.EitherLeft.value"));
prove<Equals<
  typeof ieitherleft,
  {
...
prove<Equals<typeof ieitherright.value, string>>(requireMajor("either.EitherRight.value"));
prove<Equals<
  typeof ieitherright,
  {
...
(function validateIEncoder<TIn, A>() {
  ...
  prove<Equals<typeof idecoder.encode, (a: A) => TIn>>(requireMajor("encoder.Encoder.encode"));
  prove<Equals<typeof idecoder.contramap, <B>(f: (b: B) => A) => encoder.Encoder<TIn, B>>>(requireMajor("encoder.Encoder.contramap"));
  prove<Equals<
    typeof idecoder,
    {
      encode: typeof idecoder.encode,
...
(function validateIMaybe<A>() {
  ...
  prove<Equals<typeof imaybe.matchCase, <B>(cases: maybe.MaybeCaseScrutinizer<A, B>) => B>>(requireMajor("maybe.IMaybe.matchCase"));
...
prove<Equals<typeof imaybejust.value, string>>(requireMajor("maybe.MaybeJust.value"));
prove<Equals<
  typeof imaybejust,
  {
...
(function validateIValidation<L extends object | any[], A>() {
  ...
  prove<Equals<typeof ivalidation.matchCase, <B>(cases: validation.ValidationCaseScrutinizer<L, A, B>) => B>>(requireMajor("validation.IValidation.matchCase"));
...
prove<Equals<typeof ivalidationvalid.failure, string[]>>(requireMajor("validation.ValidationInvalid.failure"));
prove<Equals<
...
prove<Equals<typeof ivalidationinvalid.value, string>>(requireMajor("validation.ValidationValid.value"));
prove<Equals<
